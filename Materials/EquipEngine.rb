...
module YEA
  module EQUIP
    ...
    DEFAULT_BASE_SLOTS = [ 0, 1, 2, 3, 7, 8, 6, 4, 4]
    ...
    # TypeID => ["Type Name", Removable?, Optimize?],
           0 => [   "Waffe",      false,      true],
           1 => [   "Schild",       true,      true],
           2 => [ "Kopfschutz",       true,      true],
           3 => [ "Körperschutz",       true,      true],
           4 => ["Accessoire",       true,     false],
           5 => [    "Umhang",       true,      true],
           6 => [ "Halskette ",       true,      true],
           7 => [ "Handschuhe ",       true,      true],
           8 => [ "Schuhe",       true,      true],
    } # Do not remove this.
