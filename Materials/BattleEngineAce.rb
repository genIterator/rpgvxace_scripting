...
module YEA
  module BATTLE
    ...
    #=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
    HELP_TEXT_ALL_FOES        = "Alle Gegner"
    HELP_TEXT_ONE_RANDOM_FOE  = "Ein zufälliger Gegner"
    HELP_TEXT_MANY_RANDOM_FOE = "%d zufällige Gegner"
    HELP_TEXT_ALL_ALLIES      = "Alle Verbündeten"
    HELP_TEXT_ALL_DEAD_ALLIES = "Alle toten Verbündeten"
    HELP_TEXT_ONE_RANDOM_ALLY = "Ein zufälliger Verbündeten"
    HELP_TEXT_RANDOM_ALLIES   = "%d zufällige Verbündete"
    ...
    POPUP_SETTINGS ={
      ...
      :weakpoint  => "Sehr effektiv", # Appears if foe is weak to element.
      :resistant  => "Resistent",    # Appears if foe is resistant to element.
      :immune     => "Immun",    # Appears if foe is immune to element.
      :absorbed   => "Absorbiert",    # Appears if foe can absorb the element.
