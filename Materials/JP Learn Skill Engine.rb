...
module YEA
  module LEARN_SKILL
    ...
    #=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
    COMMAND_NAME = "Lernen"    # Name used for Learn Skill command.
    ...
    LEARNED_TEXT   = "Gelernt"  # Text to indicate skill has been learned.
    ...
    GOLD_TEXT         = "Kosten"     # Text used for gold costs.
    LEARN_SKILL_TEXT  = "%s lernen?"     # Text used to learn skill.
    LEARN_CANCEL_TEXT = "Abbrechen"        # Text used for do not learn.
